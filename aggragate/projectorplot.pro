...
lposylist=list(yt1,yt1,yt2,yt2,yt3,yt3,yt4,yt4)
	...
	p10=scatterplot(x,y,magnitude=zbyt,xtitle=xttl,ytitle=yttl,$
				...
				/curr,layout=[2,4,lnum],RGB_TABLE=72,pos=poslist[lnum-1])
	p10.aspect_ratio=1

cb1=colorbar(ORIENTATION=0,RGB_TABLE=72,range=[1,ceil(zmax)],title=zttl,target=p10,pos=cposlist[lnum-1]););pos=cpos1)
...
;	print,'cyb1=',c1p[1]
	...
	cb2=colorbar(target=p20,ORIENTATION=0,RGB_TABLE=72,range=[0,4],title=zttl,pos=cposlist[lnum-1])
...
;	print,'cxr2=',c2p[2]
	...
	p30=scatterplot(x,y,magnitude=zbyt,xtitle=xttl,ytitle=yttl,$
				...
				/curr,layout=[2,4,lnum],RGB_TABLE=72,pos=poslist[lnum-1])
	p30.aspect_ratio=1
	cb3=colorbar(target=p30,ORIENTATION=0,RGB_TABLE=72,range=[floor(zmin),ceil(zmax)],title=zttl,pos=cposlist[lnum-1])
...
;;;  M_A
	...
	p40=scatterplot(x,y,magnitude=zbyt,xtitle=xttl,ytitle=yttl,$
				...
				/curr,layout=[2,4,lnum],RGB_TABLE=72,pos=poslist[lnum-1])
	p40.aspect_ratio=1
	cb4=colorbar(target=p40,ORIENTATION=0,RGB_TABLE=72,range=[zmin,zmax],title=zttl,pos=cposlist[lnum-1])
...
;;; V_N
	...
	p50=scatterplot(x,y,magnitude=zbyt,xtitle=xttl,ytitle=yttl,$
				...
				/curr,layout=[2,4,lnum],RGB_TABLE=72,pos=poslist[lnum-1])
	p50.aspect_ratio=1
	cb5=colorbar(target=p50,ORIENTATION=0,RGB_TABLE=72,range=[zmin,zmax],title=zttl,pos=cposlist[lnum-1])
...
;;; TH_BN
	...
	p60=scatterplot(x,y,magnitude=zbyt,xtitle=xttl,ytitle=yttl,$
				...
				/curr,layout=[2,4,lnum],RGB_TABLE=72,pos=poslist[lnum-1])
	p60.aspect_ratio=1
	cb6=colorbar(target=p60,ORIENTATION=0,RGB_TABLE=72,range=[zmin,zmax],title=zttl,pos=cposlist[lnum-1])
...
;;; FM
	...
	p70=scatterplot(x,y,magnitude=zbyt,xtitle=xttl,ytitle=yttl,$
				...
				/curr,layout=[2,4,lnum],RGB_TABLE=72,pos=poslist[lnum-1])
	p70.aspect_ratio=1
	cb7=colorbar(target=p70,ORIENTATION=0,RGB_TABLE=72,range=[zmin,zmax],title=zttl,pos=cposlist[lnum-1])
...
;;; DIST
	...
	p80=scatterplot(x,y,magnitude=zbyt,xtitle=xttl,ytitle=yttl,$
				...
				/curr,layout=[2,4,lnum],RGB_TABLE=72,pos=poslist[lnum-1])
	p80.aspect_ratio=1
	cb8=colorbar(target=p80,ORIENTATION=0,RGB_TABLE=72,range=[zmin,zmax],title=zttl,pos=cposlist[lnum-1])
...
;	PRINT,"cDpos=[",cb8.pos
	...
	t8.save,dire+'parameter_projections.png',res=600
	p10.close
end
