...
function typeCheck1,kindThresh
	errorBuilder=[0,1]
	typ=-1
	print,kindThresh
...
function thrloop1, y,th,dw,typ,typi,typf,extras,cleans=cleans
...
function monotize21,y,t;returns an array with 1 where monotonically increasing and starts returning 0  when that stops being true until things start increasing again. ignores random spikes
...
pro threshFlag1, plt,t,kindThresh=kindThesh,mnt=mnt,newName=newName,dointerpolate=dointerpolate,interplot=interplot,monoNAME=monoName
